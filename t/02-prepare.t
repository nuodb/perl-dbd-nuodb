...
my $dbh = DBI->connect('dbi:NuoDB:test@'.$host, "dba", "goalie", { PrintError => 0, schema => 'dbi' });
...
my $dbh_raiseerror = DBI->connect('dbi:NuoDB:test@'.$host, "dba", "goalie", {PrintError => 0, RaiseError => 1});
eval {
...
my $dbh_disconnect1 = DBI->connect('dbi:NuoDB:test@'.$host, "dba", "goalie", { PrintError => 0, schema => 'dbi' });
...
my $dbh_disconnect2 = DBI->connect('dbi:NuoDB:test@'.$host, "dba", "goalie", { PrintError => 0, schema => 'dbi' });
...
my $dbh_disconnect3 = DBI->connect('dbi:NuoDB:test@'.$host, "dba", "goalie", { PrintError => 0, schema => 'dbi' });
...
my $dbh_disconnect4 = DBI->connect('dbi:NuoDB:test@'.$host, "dba", "goalie", { PrintError => 0, schema => 'dbi' });
